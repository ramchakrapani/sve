...
function App() {
  ...
  return (
    <div
      className={`w-full h-full min-h-[150vh] bg-white ${darkMode && "dark"}`}
    >
      <div className='w-full h-full min-h-[200vh] bg-white '>
        <div className='dark:bg-gradient-to-tr from-[#0235a3] via-[#030a1c] to-[#05174e]'>
          ...
          <section id='home' className='px-0 lg:px-5 2xl:px-50 py-0 lg:py-0'>
            <Header />
          </section>
        </div>
